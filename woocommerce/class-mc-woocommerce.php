 ...
 * @subpackage MesmericCommerce/woocommerce
 */
class MC_WooCommerce {
    ...
    public function init(): void {
        ...
        // Product hooks
        add_action('woocommerce_before_shop_loop_item', [$this, 'quick_view_button'], 15);
        add_action('woocommerce_after_add_to_cart_button', [$this, 'wishlist_button'], 15);

        // AJAX handlers
        add_action('wp_ajax_mc_quick_view', [$this, 'handle_quick_view']);
        add_action('wp_ajax_nopriv_mc_quick_view', [$this, 'handle_quick_view']);
        add_action('wp_ajax_mc_add_to_wishlist', [$this, 'handle_add_to_wishlist']);
        add_action('wp_ajax_mc_remove_from_wishlist', [$this, 'handle_remove_from_wishlist']);
