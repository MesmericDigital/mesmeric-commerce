<!-- App.vue - Main admin interface component for Mesmeric Commerce -->
<template>
    <div class="mc-admin px-4 py-4 relative min-h-screen">
        <!-- Header -->
        ...
        <nav class="tabs tabs-boxed mb-6">
            <router-link
                ...
                :to="navItem.path"
                class="tab"
                :class="{ 'tab-active': isActiveRoute(navItem.path) }"
            >
                {{ navItem.name }}
            </router-link>
        </nav>
